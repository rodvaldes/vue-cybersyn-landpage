          ...
          <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
            <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
              ...
              <div class="hidden md:block md:ml-10 md:pr-4">
                ...
                <a href="#" class="ml-8 font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out">Empresa</a>
                <a href="#" class="ml-8 font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out">Contacto</a>
    ...
    <div class="py-12 bg-white">
      <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          <p class="text-base leading-6 text-indigo-600 font-semibold tracking-wide uppercase">High Performance IT</p>
          <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
            Servicio de Consultoría de Tecnologías de Información
          </h3>
          <p class="mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto">
            El servicio de consultoría de Cybersyn es Altamente especializada y el objetivo es proveer el servicio de la más
            alta calidad gracias a la aplicación de mejora continua e innovación continua.
          </p>
        </div>
          ...
          <ul class="md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            <li>
              <div class="flex">
                ...
                <div class="ml-4">
                  <h4 class="text-lg leading-6 font-medium text-gray-900">Camino a la nube</h4>
                  <p class="mt-2 text-base leading-6 text-gray-500">
                    Aprovecha las ventajas de la nube. Preparamos un detallado plan de migración de aplicaciones a la nube.
                  </p>
                </div>
              </div>
            </li>
            <li class="mt-10 md:mt-0">
              <div class="flex">
                ...
                <div class="ml-4">
                  <h4 class="text-lg leading-6 font-medium text-gray-900">Atlassian Experts</h4>
                  <p class="mt-2 text-base leading-6 text-gray-500">
                    <!--Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.-->
                    Implementación de ciclo de desarrollo End 2 end integrando Herramientas Atlassian. Jira, Confluence, Bitbucket.
                  </p>
                </div>
              </div>
            </li>
            <li class="mt-10 md:mt-0">
              <div class="flex">
                ...
                <div class="ml-4">
                  <h4 class="text-lg leading-6 font-medium text-gray-900">DevOps</h4>
                  <p class="mt-2 text-base leading-6 text-gray-500">
                    Te ayudamos con una evaluación y la generación de un plan de acción para implementación de practicas devops.
                  </p>
                </div>
              </div>
            </li>
            <li class="mt-10 md:mt-0">
              <div class="flex">
                ...
                <div class="ml-4">
                  <h4 class="text-lg leading-6 font-medium text-gray-900">Innovación Continua</h4>
                  <p class="mt-2 text-base leading-6 text-gray-500">
                    Te asesoramos en la implementación de metodologías que aceleran la capacidad de innovar y poder adaptar asi tu negocio a los desafios.
                  </p>
                </div>
              </div>
            </li>
